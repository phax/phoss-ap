...
ALTER TABLE inbound_transaction         ADD COLUMN verification_details CLOB;
CALL SYSPROC.ADMIN_CMD('REORG TABLE inbound_transaction');

ALTER TABLE inbound_transaction_archive ADD COLUMN verification_result  VARCHAR(20);
ALTER TABLE inbound_transaction_archive ADD COLUMN verification_details CLOB;
CALL SYSPROC.ADMIN_CMD('REORG TABLE inbound_transaction_archive');
